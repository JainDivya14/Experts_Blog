<%-- 
    Document   : exp_profile
    Created on : May 16, 2020, 12:09:42 PM
    Author     : Lenovo
--%>
...
<BODY style="background:#bdffc4;">
    ...
    <%
        ...
        <button style="margin-left: 85px; width: 10%" class="btn"><a href="exp_update_profile.jsp">Update Profile</a></button>
        <button style="margin-left: 85px; width: 10%" class="btn"><a href="exp_pass_change.jsp">Change Password</a></button>
            <%
            }
            }
            catch(Exception e){
