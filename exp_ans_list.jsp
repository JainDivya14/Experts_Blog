<%-- 
    Document   : exp_ans_list
    Created on : May 16, 2020, 3:29:41 PM
    Author     : Lenovo
--%>
...
<TITLE>Experts' Blog - Your Answers</TITLE>
...
<BODY style="background:#bdffc4;">
   ...
   <h1><a href="index.jsp"><img src="Background/eb_logo_header.png" height="25%" width="25%"></a> <a href="logout.jsp"><button type="button" class="bt" data-toggle="modal" data-target="">Logout</button></a></h1>
    ...
    <h4 class="list_header" style="background:lightgray;text-align: left;font-size:25px;">Answered Questions</h4> 

        <%
    try{
                                Class.forName("com.mysql.jdbc.Driver");
                                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/eb","root","");
                                PreparedStatement ps=con.prepareStatement("select qid,qname,DATE_FORMAT(log,'%b %d, %Y') from ques_ans where ansid IN (select ansid from ans_table where answeredby=?) order by log DESC");
