<%-- 
    Document   : askbyme
    Created on : May 16, 2020, 7:03:33 AM
    Author     : Lenovo
--%>
...
<TITLE>Experts' Blog - Your Questions</TITLE>
...
<BODY style="background:#bdffc4;">
   ...
   <h4 class="list_header" style="background:lightgray;text-align: left;font-size:25px;">Asked Questions</h4> 

        <%
    try{
                                Class.forName("com.mysql.jdbc.Driver");
                                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/eb","root","");
                                PreparedStatement ps=con.prepareStatement("select qid,qname,DATE_FORMAT(log,'%b %d, %Y') from ques_ans where askedby=? order by log DESC");
